  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Read untold poems, artworks, and stories by LA's creators. A unique space celebrating voices across Los Angeles."
        />
      </Head>
      ...
      <div style={{
        ...
        <main style={{
          ...
          <section style={{
            ...
            <p>
              Los Angeles Lore is your portal to stories that might otherwise go unheard. We bring together a community of writers, artists, and dreamers capturing LA’s essence through personal tales.
            </p>
            <p>
              Whether it’s a memory from Echo Park or a vision of Silver Lake’s gardens, each submission reflects the pulse of a neighborhood, the resilience of its people, and the culture that shapes it.
            </p>
          </section>
