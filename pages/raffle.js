  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="Join the LA Lore Raffle for a chance to win exclusive merch and prizes. Celebrate creativity and community through storytelling."
        />
      </Head>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <header style={{ marginBottom: '2rem' }}>
            ...
            <div style={{ marginTop: '1.5rem', marginBottom: '1.5rem', fontSize: '1rem', color: '#444', lineHeight: '1.6' }}>
              <p>
                The Los Angeles Lore Raffle celebrates our creative community with rewards that recognize passion and talent.
                Submit your entry to stand a chance to receive limited-edition gifts and exclusive recognition from our editorial team.
              </p>
              <p>
                Whether you're a storyteller, artist, or reader, this raffle is our way of saying thank you for being part of LA’s vibrant narrative.
                Winners are chosen randomly, and participation is completely free!
              </p>
            </div>
